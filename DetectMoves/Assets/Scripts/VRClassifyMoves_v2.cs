...
public class VRClassifyMoves_v2 : MonoBehaviour {
    ...
    void Start () {
        motiveData.GetComponent<VRHandsStatusData_v2>().UpdateHandsStatus+= new ChangeHandsStatusHandler(OnUpdatedHandsStatusReceived);
